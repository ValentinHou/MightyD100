...
image: [Mapv5](../../Mapv5.png) ### Link to the map image file  
bounds: [[0,0], [4160, 8348]] ### Size of the map in px Width_x, Height_y  
height: 850px ### Size of the leaflet embed in px on your screen  
width: 95% ### Size of the leaflet embed in your note  
lat:  2080 ### To center the map, make this half of the map width.  
long: 3700 ### To center the map, make this half of the map height.  
...
recenter: false  
darkmode: false ### marker  marker: default,1712,2924,Barronnerie Or-Azur,test,,
